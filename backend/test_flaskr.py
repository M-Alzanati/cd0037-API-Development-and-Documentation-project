...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_404_if_no_questions_by_category(self):
    ...
    def test_search_questions_by_value(self):
        res = self.client().post('/api/v1.0/questions/search', json={'searchTerm': 'movie'})
        data = json.loads(res.data)
    ...
    def test_404__if_no_search_questions_by_value(self):
        res = self.client().post('/api/v1.0/questions/search', json={'searchTerm': 'movie1111'})
        data = json.loads(res.data)
    ...
    def test_get_quizzes(self):
        res = self.client().post('/api/v1.0/quizzes', json={'quiz_category': {'id': 1}, 'previous_questions': []})
        data = json.loads(res.data)
    ...
    def test_404__if_no_quizzes(self):
        res = self.client().post('/api/v1.0/quizzes', json={'quiz_category': {'id': 100}, 'previous_questions': []})
        data = json.loads(res.data)
